...
export function GET(context) {
 ...
 for(const p of publicPages)items.push({id:`${site}${p.path}/`,url:`${site}${p.path}/`,title:p.title,content_html:p.body,summary:p.description,date_published:`${p.date}T00:00:00Z`,tags:['The Systems Lens']});
